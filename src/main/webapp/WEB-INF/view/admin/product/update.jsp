                                ...
                                <div class="mt-5">
                                    <div class="row">
                                        <div class="col-md-6 col-12 mx-auto">
                                            ...
                                            <hr>
                                            <form:form method="POST" class="row g-3" action="/admin/product/update"
                                                ...
                                                <div class="mb-3" style="display: none;">
                                                    ...
                                                    <form:input type="text" name="" path="id" class="form-control" />
                                                </div>
                                                ...
                                                <div class="col-12 col-md-6">
                                                    ...
                                                    <form:input type="number" name="" path="price"
                                                    class="form-control ${not empty errorPrice ? 'is-invalid' : ''}" />
                                                    ${errorPrice}
                                                </div>
                                                <div class="mb-3">
                                                    <label for="" class="form-label">Detail Description:</label>
                                                    <form:textarea rows="3" type="text" name="" path="detailDesc"
                                                    class="form-control ${not empty errorDetailDesc ? 'is-invalid' : ''}" />
                                                    ${errorDetailDesc}
                                                </div>
                                                <div class="col-12 col-md-6">
                                                    <label for="" class="form-label">Short Description:</label>
                                                    <form:input type="text" name="" path="shortDesc"
                                                        class="form-control ${not empty errorShortDesc ? 'is-invalid' : ''}" />
                                                        ${errorShortDesc}
                                                </div>
                                                <div class="col-12 col-md-6">
                                                    <label for="" class="form-label">Quantity:</label>
                                                    <form:input type="number" name="" path="quantity"
