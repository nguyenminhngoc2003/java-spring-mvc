                                ...
                                <div class="mt-5">
                                    <div class="row">
                                        <div class="col-md-6 col-12 mx-auto">
                                            <h3>Update order</h3>
                                            <hr>
                                            <form:form method="POST" class="row g-3" action="/admin/order/update"
                                                ...
                                                <div class="mb-3">
                                                    <label for="">Order id = ${newOrder.id}</label>
                                                    &nbsp; &nbsp; &nbsp; &nbsp;
                                                ...
                                                <div class="mb-3 col-12 col-md-6">
                                                    ...
                                                    <form:input type="text" class="form-control" disabled="true" path="user.fullName"></form:input>
                                                </div>
